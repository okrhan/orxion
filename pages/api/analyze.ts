...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const prompts: Record<string, string> = {
      strategy: `You are a top-tier McKinsey/Big 4 strategy partner. Analyze this business with maximum rigor. Return ONLY raw JSON starting with { and ending with }. No markdown, no backticks.
...
${stmtNote ? `FINANCIAL STATEMENTS: ${stmtNote} — extract and use ALL financial figures.` : ""}

Return this COMPLETE JSON with real data-driven analysis for every field:
{"score":75,"summary":"One incisive sentence with specific numbers from the data","metrics":{"Margin":"28%","LTV:CAC":"3.2x","Runway":"6 mo","Unit Econ":"Marginal"},"radarLabels":["Growth","Margin","Retention","Marketing","Ops"],"radarVals":[65,40,70,55,60],"channelLabels":["SEO","Paid","LinkedIn","Social","Email"],"channelVals":[75,60,45,80,55],"revenueHistory":[42,45,48,44,52,58,56,62,60,68,72,74],"problems":["Specific problem with data","Problem 2","Problem 3","Problem 4"],"rootCauses":["Root cause 1","Root cause 2","Root cause 3"],"pillars":[{"title":"Pillar 1","desc":"Two actionable sentences."},{"title":"Pillar 2","desc":"Two sentences."},{"title":"Pillar 3","desc":"Two sentences."}],"plan":{"d30":["Action 1","Action 2","Action 3"],"d60":["Action 1","Action 2","Action 3"],"d90":["Action 1","Action 2","Action 3"]},"verdict":"Bold conclusion.","benchmarks":[{"metric":"Operating Margin","value":"X%","peerAvg":"Y%","best":"Z%","status":"behind"},{"metric":"Cost/Revenue Ratio","value":"X%","peerAvg":"Y%","best":"Z%","status":"behind"},{"metric":"Revenue Growth","value":"X%","peerAvg":"Y%","best":"Z%","status":"ahead"}],"scenarios":[{"name":"Bear Case","probability":"25%","assumption":"Costs flat, revenue declines 10%","outcome":"Describe financial outcome","color":"red"},{"name":"Base Case","probability":"55%","assumption":"Moderate improvements executed","outcome":"Describe financial outcome","color":"blue"},{"name":"Bull Case","probability":"20%","assumption":"Full strategy executed successfully","outcome":"Describe financial outcome","color":"green"}],"risks":[{"risk":"Risk name 1","likelihood":"High","impact":"Critical","mitigation":"Specific mitigation action"},{"risk":"Risk name 2","likelihood":"Medium","impact":"High","mitigation":"Specific mitigation"},{"risk":"Risk name 3","likelihood":"Low","impact":"Medium","mitigation":"Specific mitigation"},{"risk":"Risk name 4","likelihood":"Low","impact":"Critical","mitigation":"Specific mitigation"}]}`,
