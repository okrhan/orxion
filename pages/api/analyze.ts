...
INPUT: Company=${body.name} Industry=${body.industry} Stage=${body.stage} Revenue=$${body.revenue||"?"}/mo Costs=$${body.costs||"?"}/mo CAC=$${body.cac||"?"} LTV=$${body.ltv||"?"} Team=${body.team||"?"} Web=${body.website||"N/A"}
COMPETITORS: ${body.competitor1||"N/A"} | ${body.competitor2||"N/A"} | ${body.competitor3||"N/A"}
DIFFERENTIATOR: ${body.differentiator||"N/A"} TARGET MARKET: ${body.targetMarket||"N/A"}
