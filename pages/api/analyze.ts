...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const prompts: Record<string, string> = {
      strategy: `You are a McKinsey/BCG strategy partner + PE analyst. Decision-grade analysis only. Brutally honest. Quantify everything.
...
Return ONLY valid compact JSON. No markdown. No line breaks inside strings:
{"score":75,"dataCompleteness":"72%","confidenceLevel":"Medium","summary":"Specific sentence with real numbers","metrics":{"Margin":"X%","LTV:CAC":"X","Runway":"X mo","Unit Econ":"X"},"dataFlags":["Flag 1","Flag 2"],"leveragePoint":"Key insight","radarLabels":["Growth","Margin","Retention","Marketing","Ops"],"radarVals":[65,40,70,55,60],"channelLabels":["SEO","Paid","LinkedIn","Social","Email"],"channelVals":[75,60,45,80,55],"revenueHistory":[42,45,48,52,58,56,62,68,72,74],"problems":["Problem 1","Problem 2","Problem 3"],"rootCauses":["Cause 1","Cause 2","Cause 3"],"notToDo":["Avoid 1","Avoid 2"],"financialImpact":{"currentRevenue":"$X/mo","currentCosts":"$X/mo","currentMargin":"X%","projectedRevenue":"$X/mo","projectedMargin":"X%","netImpact":"$X over 12mo"},"pillars":[{"title":"P1","desc":"Two sentences.","impact":"$X","effort":"Medium","timeToImpact":"3 mo"},{"title":"P2","desc":"Two sentences.","impact":"$X","effort":"Low","timeToImpact":"1 mo"},{"title":"P3","desc":"Two sentences.","impact":"$X","effort":"High","timeToImpact":"6 mo"}],"plan":{"d30":["A1","A2","A3"],"d60":["A1","A2","A3"],"d90":["A1","A2","A3"]},"verdict":"Honest conclusion.","benchmarks":[{"metric":"Op Margin","value":"X%","peerAvg":"Y%","best":"Z%","status":"behind"},{"metric":"Cost/Rev","value":"X%","peerAvg":"Y%","best":"Z%","status":"behind"},{"metric":"Rev/Employee","value":"$X","peerAvg":"$Y","best":"$Z","status":"behind"}],"scenarios":[{"name":"Bear","probability":"25%","assumption":"A","outcome":"O","color":"red"},{"name":"Base","probability":"55%","assumption":"A","outcome":"O","color":"blue"},{"name":"Bull","probability":"20%","assumption":"A","outcome":"O","color":"green"}],"risks":[{"risk":"R1","likelihood":"High","impact":"Critical","mitigation":"M1"},{"risk":"R2","likelihood":"Medium","impact":"High","mitigation":"M2"},{"risk":"R3","likelihood":"Low","impact":"Medium","mitigation":"M3"}]}``,
